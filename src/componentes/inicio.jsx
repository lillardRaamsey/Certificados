...
export default function Inicio() {
  ...
  const { user, userData, loading } = useAuth(); // Aquí obtenemos el objeto user de Firebase Auth
  ...
  // Si estás esperando la respuesta del servidor para el cargo
  if (loading) {
      ...
      <div className="overlay">
        ...
        {user ? (
          ...
          <>
            {isAdmin && (
              <Link to="/admin">
                <div className="button">Administración</div>
              </Link>
            )}
            ...
            {isAdmin && (
              <Link to="/dir">
                <div className="button">Cargos</div>
              </Link>
            )}
          </>
          </div>
